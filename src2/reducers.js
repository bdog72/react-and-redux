...
function user (state = initialUsersState, action) {
  switch (action.type) {
...
function feed (state = initialState, action) {
  switch (action.type) {
    case SETTING_FEED + LISTENER:
      return {
        ...state,
        isFetching: true
      }
    case SETTING_FEED_LISTENER_USER:
      return {
        ...state,
        isFetching: false,
        error: action.error
  ...
  switch (action.type) {
    ...
    case REMOVE_REPLY:
      return {
        ...
        isFetching: false,
        error: '',
        [action.duckId]: repliesAndLastUpdated(state[action.duck], action)
      }
    default:
      return state
  }
